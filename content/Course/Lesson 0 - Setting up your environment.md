...
<a href='https://codespaces.new/Shrub24/raid-codespace/tree/image-config?template=false&quickstart=1'><img src='https://github.com/codespaces/badge.svg' alt='Open in GitHub Codespaces' style='max-width: 100%;'></a>
</div>

### Step 3: Wait for Setup (1-2 minutes)

GitHub will:
1. Create a virtual machine for you
2. Install all dependencies
3. Set up Ollama with a local model
...
1. Look for the `Lesson 1` folder in the file explorer
2. Open `lesson1-litellm.ipynb`
